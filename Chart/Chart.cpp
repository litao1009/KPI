...
BEGIN_MESSAGE_MAP(CChartApp, CWinApp)
	ON_COMMAND(ID_APP_ABOUT, &CChartApp::OnAppAbout)
	// 基于文件的标准文档命令
...
CChartApp::CChartApp()
{
	...
	SetAppID(_T("Chart.AppID.NoVersion"));
...
BOOL CChartApp::OnIdle( LONG lCount )
{
	OgreEnv::GetInstance().RenderOneFrame();
	return TRUE;
}

BOOL CChartApp::IsIdleMessage( MSG* pMsg )
{
