...
class	TexNumber : public Ogre::MovableObject, public Ogre::Renderable
{
	class	Imp;
...
public:
	...
	TexNumber(const Ogre::IdType& id, Ogre::ObjectMemoryManager *objectMemoryManager);
...
class	TexNumberFactory : public TExtMovableObjFactory<TexNumber>
{
};